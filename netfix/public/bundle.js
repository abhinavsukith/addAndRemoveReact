...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _dynamic_list = __webpack_require__(187);

	var _dynamic_list2 = _interopRequireDefault(_dynamic_list);
	...
	var App = function (_Component) {
		...
		function App() {
			...
			_this.addTitle = function (id, title, img) {

				var addObj = { "title": title,
					"id": id,
					"img": img
				};
				...
				_axios2.default.post('/addMovieRecord', addObj).then(function (response) {
			...
			_this.removeTitle = function (id) {

				console.log("removeTitle  " + id);

				var addObj2 = { "id": id };

				_axios2.default.post('/deleteMovieRecord', addObj2).then(function (response) {
					console.log(response.data);
					this.setState({
						movieList: response.data });
				}).catch(function (error) {
			...
			_this.state = { movieList: { "mylist": [], "recommendations": [] }
			};
			_this.addTitle = _this.addTitle.bind(_this);
			_this.removeTitle = _this.removeTitle.bind(_this);
		...
		_createClass(App, [{
			...
			value: function componentDidMount() {
				...
				_axios2.default.get('/getData').then(function (response) {
					_this2.setState({ movieList: response.data });
				});
			}
		}, {
			key: 'render',
			value: function render() {
				return _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement(_dynamic_list2.default, { movieList: this.state.movieList, add: this.addTitle, remove: this.removeTitle })
				);
			}
		}]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function List(props) {
	  ...
	  var myList = props.movieList.mylist.map(function (val) {
	    return _react2.default.createElement(
	      'div',
	      { key: val.id, className: 'repeater' },
	  ...
	  var myRecoms = props.movieList.recommendations.map(function (val) {
	    return _react2.default.createElement(
	      'div',
	      { key: val.id, className: 'repeater' },
	      _react2.default.createElement('img', { src: val.img, alt: 'Card image cap' }),
	      _react2.default.createElement(
	        'h6',
	        null,
	        val.title
	      ...
	      _react2.default.createElement(
	        ...
	        { className: 'btn btn-primary', onClick: function onClick() {
	            return props.add(val.id, val.title, val.img);
	          } },
	        'Add'
	      )
	    );
	  ...
	  var myTitles = props.movieList.mylist.map(function (val) {
	    return _react2.default.createElement(
	      'div',
	      { key: val.id, className: 'myListdiv' },
	      _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(
